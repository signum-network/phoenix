...
export const NoActiveAccount: React.FC = () => {
    ...
    // @ts-ignore
    const t = (item: string): string => i18n.t(transactions.screens.send.noActiveAccount[item]);
    ...
    return (
        <TouchableOpacity activeOpacity={1} style={styles.view} onPress={gotoAddAccountScreen}>
