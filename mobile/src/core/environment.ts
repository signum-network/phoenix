...
import { BURSTALERTS_HOST_URL, CRYPTOCOMPARE_HOST_URL, DEFAULT_NODE_HOST, DEFAULT_PASSCODE_TIME, RELIABLE_NODE_HOSTS } from 'react-native-dotenv';

// So we check it like this
// tslint:disable-next-line: max-line-length
if (!DEFAULT_NODE_HOST || !DEFAULT_PASSCODE_TIME || !CRYPTOCOMPARE_HOST_URL || !BURSTALERTS_HOST_URL || !RELIABLE_NODE_HOSTS) {
