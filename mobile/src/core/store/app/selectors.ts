...
export const selectCurrentNode = (state: ApplicationState): string => state.app.userSettings.currentNodeHost || state.app.appSettings.apiSettings.nodeHost;
...
export const selectAgreedToTerms = (state: ApplicationState): boolean => state.app.userSettings.agreedToTerms || false;
