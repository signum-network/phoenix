...
export function setCredentials({username, password}: KeychainCredentials, service?: string): Promise<false | Keychain.Result> {
...
export function getCredentials(service?: string): Promise<boolean | KeychainCredentials> {
