...
describe("deeplink", () => {
  describe("legacy", () => {
    ...
    it("it should create expected payload - ignore unknown props", () => {
      const legacyLink =
        "signum://requestBurst?receiver=S-LJRV-9LE8-VJ5B-57W4C&amountNQT=20000000000&feeNQT=2205000&immutable=false&message=4c956fdb7701&messageIsText=false&inject=malicious";
      const info = getDeeplinkInfo(legacyLink);
      const data = info.decodedPayload as DeeplinkPayPayload;
